...
// function change(){
        ...
        echo color("red","\n===========(REDEEM VOUCHER)===========");
        echo "\n".color("yellow","!] Claim voc MAKANCERIAOVO");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        }
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAKANCERIAOVO"}');
        ...
        echo "\n".color("yellow","!] Claim voc MAKANCERIA");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAKANCERIA"}');
